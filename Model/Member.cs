...
namespace Kcsar.Database.Model
{
  ...
  public class Member : ModelObject
  {
    ...
    public virtual ICollection<MissionResponder> MissionResponses { get; set; }
      ...
      : base()
    {
      ...
      this.MissionResponses = new List<MissionResponder>();
    ...
    {
      //if (this.EntityState != System.Data.EntityState.Detached && (this.Memberships == null || this.Memberships.IsLoaded == false))
      //{
      //    this.Memberships.Attach(this.Memberships.CreateSourceQuery().Include("Status"));
      //}
    ...
    public override bool Validate()
    {
      ...
      {
        errors.Add(new RuleViolation(this.Id, "FirstName", "", "Required"));
      }
