...
namespace Kcsar.Database.Data
{
  ...
  public class TrainingCourseRow : ModelObjectRow
  {
    [Required]
    ...
    public virtual ICollection<TrainingRecordRow> TrainingAward { get; set; }
    public virtual ICollection<ComputedTrainingRecordRow> ComputedAwards { get; set; }
    public virtual ICollection<TrainingRow> Trainings { get; set; }
