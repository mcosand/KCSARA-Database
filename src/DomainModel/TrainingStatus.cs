...
namespace Kcsar.Database.Model
{
  ...
  public class CompositeTrainingStatus
  {
    ...
    //public static CompositeTrainingStatus Compute(MemberRow m, IEnumerable<TrainingCourseRow> courses, DateTime when)
    //{
    ...
    //public static CompositeTrainingStatus Compute(MemberRow m, IEnumerable<ComputedTrainingAward> awards, IEnumerable<TrainingCourseRow> courses, DateTime when)
    //{
