...
namespace Kcsara.Database.Web.Services
{
  ...
  public static class BadgeService
  {
    ...
    /// <returns></returns>
    public static MemoryStream CreateCards(IEnumerable<MemberRow> members, DateTime expiration)
    {
    ...
    private static void Render_FrontContent(PdfContentByte canvas, MemberRow member)
    {
    ...
    private static void Render_BackContent(PdfContentByte canvas, MemberRow member, bool passport)
    {
