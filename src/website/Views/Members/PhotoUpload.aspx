...
<% using (Html.BeginForm<MembersController>(f => f.PhotoPreview(), FormMethod.Post, new { enctype = "multipart/form-data" }))
  ...
  <tr>
    <td><%= Html.Image(this.ResolveUrl(Kcsara.Database.Web.api.MembersController.GetPhotoOrFillInPath(m.PhotoFile)), "Badge Photo", new{style="border:2px solid black; height:6em; width:4.5em;"}) %></td>
    <td><%= m.FullName %></td>
