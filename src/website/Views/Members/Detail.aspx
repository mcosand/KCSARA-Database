...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div id="card" style="padding: 2px; width: 25em; border: solid 1px black; ">
    ...
    <div style="margin:.2em .2em 0 0; position:relative;">
      <div style="float:left;"><%= Html.Image(this.ResolveUrl(Kcsara.Database.Web.api.MembersController.GetPhotoOrFillInPath(m.PhotoFile)), "Badge Photo", new{style="border:2px solid black; height:12em; width:9em;"}) %></div>
