...
namespace Kcsara.Database.Web.Model
{
  ...
  public abstract class GeographyView
  {
    ...
    public static GeographyView BuildGeographyView(MemberAddressRow geog)
    {
      GeographyView view = BuildGeographyView(geog.Location);
      view.Id = geog.Id;
      view.Kind = Kinds.Member_Residence;
      view.Description = string.Format("{0}\n{1}\n{2}, {3}", geog.Member.FullName, geog.Street, geog.City, geog.Zip);
      view.InstanceId = geog.Member.Id;
      return view;
    }

    public static GeographyView BuildGeographyView(EventGeographyRow geog)
    {
