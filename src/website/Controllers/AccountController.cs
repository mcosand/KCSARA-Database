...
namespace Kcsara.Database.Web.Controllers
{
  ...
  public class AccountController : Controller
  {
    ...
    public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
    {
      ...
      if (returnUrl != null && !string.IsNullOrWhiteSpace(model.ClientPath) && Regex.IsMatch(model.ClientPath, "^[a-z0-9\\/-]+$", RegexOptions.IgnoreCase))
      {
        returnUrl = returnUrl.Split('#')[0] + "#" + model.ClientPath;
      }
