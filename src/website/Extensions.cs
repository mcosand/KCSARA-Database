...
namespace Kcsara.Database.Web
{
  ...
  public static class Extensions
  {
    ...
    private static string _ModelData(string imgUrl, IModelObjectRow obj)
    {
    ...
    public static string ModelData(this ViewPage control, IModelObjectRow obj)
    {
      return _ModelData(control.ResolveUrl("~/Content/images/info.png"), obj);
    }

    public static string ModelData(this ViewUserControl control, IModelObjectRow obj)
    {
      return _ModelData(control.ResolveUrl("~/Content/images/info.png"), obj);
    }
