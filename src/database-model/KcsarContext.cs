...
namespace Kcsar.Database.Model
{
  ...
  public class KcsarContext : DbContext, IKcsarContext
  {
    ...
    public virtual IDbSet<AnimalMission> AnimalMissions { get; set; }
    public virtual IDbSet<AnimalOwner> AnimalOwners { get; set; }
    public virtual IDbSet<Mission> Missions { get; set; }
    public virtual IDbSet<MissionDetails> MissionDetails { get; set; }
    public virtual IDbSet<MissionLog> MissionLog { get; set; }
    public virtual IDbSet<MissionRoster> MissionRosters { get; set; }
    public virtual IDbSet<MissionGeography> MissionGeography { get; set; }
    public virtual IDbSet<Member> Members { get; set; }
    public virtual IDbSet<PersonAddress> PersonAddress { get; set; }
    public virtual IDbSet<PersonContact> PersonContact { get; set; }
    public virtual IDbSet<MemberUnitDocument> MemberUnitDocuments { get; set; }
    //     virtual   public IDbSet<PersonSubscription> PersonSubscription { get; set; }
    public virtual IDbSet<Subject> Subjects { get; set; }
    public virtual IDbSet<SubjectGroup> SubjectGroups { get; set; }
    public virtual IDbSet<SubjectGroupLink> SubjectGroupLinks { get; set; }
    public virtual IDbSet<Training> Trainings { get; set; }
    public virtual IDbSet<TrainingAward> TrainingAward { get; set; }
    public virtual IDbSet<TrainingCourse> TrainingCourses { get; set; }
    public virtual IDbSet<Document> Documents { get; set; }
    public virtual IDbSet<TrainingRoster> TrainingRosters { get; set; }
    public virtual IDbSet<TrainingRule> TrainingRules { get; set; }
    public virtual IDbSet<TrainingRequired> RequiredTraining { get; set; }
    public virtual IDbSet<SarUnit> Units { get; set; }
    public virtual IDbSet<UnitApplicant> UnitApplicants { get; set; }
    public virtual IDbSet<UnitMembership> UnitMemberships { get; set; }
    public virtual IDbSet<UnitStatus> UnitStatusTypes { get; set; }
    public virtual IDbSet<UnitDocument> UnitDocuments { get; set; }
    public virtual IDbSet<ComputedTrainingAward> ComputedTrainingAwards { get; set; }
    public virtual IDbSet<TrainingExpirationSummary> TrainingExpirationSummaries { get; set; }
    public virtual IDbSet<CurrentMemberIds> CurrentMemberIds { get; set; }
    public virtual IDbSet<xref_county_id> xref_county_id { get; set; }
    protected IDbSet<AuditLog> AuditLog { get; set; }
    public virtual IDbSet<SensitiveInfoAccess> SensitiveInfoLog { get; set; }
    ...
    private void DoSaveChangesTracking()
    {
