...
GO
PRINT N'Creating [dbo].[RolesInRoles]...';
...
CREATE TABLE [dbo].[partners] (
    [siteId]          INT           NOT NULL,
    [ticketPage]      VARCHAR (500) NOT NULL,
...
GO
PRINT N'Creating Foreign Key on [dbo].[RolesInRoles]....';


GO
ALTER TABLE [dbo].[RolesInRoles]
    ADD FOREIGN KEY ([ChildRoleId]) REFERENCES [dbo].[aspnet_Roles] ([RoleId]);
...
GO
ALTER TABLE [dbo].[RolesInRoles]
    ADD FOREIGN KEY ([ParentRoleId]) REFERENCES [dbo].[aspnet_Roles] ([RoleId]);
