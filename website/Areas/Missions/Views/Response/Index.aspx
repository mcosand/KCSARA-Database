...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  <div class="container" data-bind="visible: !CreatingMission()">
    <div class="list-group" style="padding-top: .4em" data-bind="foreach: Missions">
      <a data-bind="attr: { href: '<%= Url.RouteUrl("MissionResponse_default", new { controller = "Response", action = "Info" }) %>/' + MissionId }" class="list-group-item">
        ...
        <div style="font-weight: bold" data-bind="text: Title"></div>
        <div class="pull-right" data-bind="text: Started.format('MMM D HH:mm')"></div>
        <div style="height:1em;" data-bind="text: Number"></div>
      </a>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
  <script type="text/javascript">
    var PageModel = function (missionInit) {
      ...
      this.Missions = ko.observableArray(mapMoment(missionInit, ['Started']));
