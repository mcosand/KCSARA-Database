...
namespace Kcsara.Database.Web.Controllers
{
    ...
    public class AnimalsController : BaseController
    {
        ...
        {
            var animals = (from a in context.Animals.Include("Owners").Include("Owners.Owner") orderby a.Name select
        ...
        {
            Animal animal = (from a in context.Animals.Include("Owners").Include("Owners.Owner").Include("MissionRosters").Include("MissionRosters.MissionRoster").Include("MissionRosters.MissionRoster.Mission") where a.Id == id select a).First();
        ...
        {
            Animal animal = (from a in context.Animals where a.Id == id select a).First();
        ...
        {
            return View((from a in context.Animals where a.Id == id select a).First());
        }
        ...
        public ActionResult CreateOwner(Guid id)
        {
            ...
            o.Animal = (from a in context.Animals where a.Id == id select a).First();
        ...
        {
            AnimalOwner o = (from ao in context.AnimalOwners.Include("Animal").Include("Owner") where ao.Id == id select ao).First();
            return InternalEditOwner(o);
        }
        ...
        private ActionResult InternalSaveOwner(AnimalOwner o, FormCollection fields)
        {
            try
            {
                ...
                else
                {
                    ...
                    Member member = (from m in context.Members where m.Id == personId select m).First();
                    o.Owner = member;
                }
        ...
        {
            return View((from ao in context.AnimalOwners.Include("Owner").Include("Animal") where ao.Id == id select ao).First());
        }
        ...
        {
            AnimalOwner o = (from ao in context.AnimalOwners where ao.Id == id select ao).First();
            context.AnimalOwners.Remove(o);
            context.SaveChanges();
        ...
        public ActionResult PhotoUpload(string id)
        {
            ...
            var x = context.Animals.Where(GetSelectorPredicate<Animal>(ids)).OrderBy(f => f.Name);
        ...
        public ActionResult PhotoPreview()
        {
            ...
            var m = context.Animals.Where(GetSelectorPredicate<Animal>(images.Keys)).OrderBy(f => f.Name);
        ...
        public ActionResult PhotoCommit(FormCollection fields)
        {
            ...
            else
            {
                ...
                var Animals = context.Animals.Where(GetSelectorPredicate<Animal>(images.Keys)).OrderBy(f => f.Name);
