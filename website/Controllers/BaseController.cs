namespace Kcsara.Database.Web.Controllers
{
    ...
    {
        protected KcsarContext context = new KcsarContext();
        ...
        protected KcsarContext GetContext()
        {
            return new KcsarContext();
        }
        ...
        protected override void Initialize(System.Web.Routing.RequestContext requestContext)
        {
            ...
            Permissions = new PermissionsProvider(User, context);
        ...
        public ActionResult SupportingDoc(Guid id, int? notify)
        {
            ...
            {
                view = (from d in ctx.Documents where d.Id == id select new DocumentView { Id = d.Id, Reference = d.ReferenceId, Title = d.FileName, Type = d.Type, Size = d.Size }).First();
            }
        ...
        public ActionResult DownloadDoc(Guid id)
        {
            ...
            using (var ctx = GetContext())
            {
                var doc = (from d in ctx.Documents where d.Id == id select d).FirstOrDefault(); //new { p = d.Contents, n = d.FileName.Replace(" ","_"), t = d.MimeType }).FirstOrDefault();
        ...
        {
            var thumb = (from d in context.Documents where d.Id == id select new { store = d.StorePath, type = d.MimeType }).First();
