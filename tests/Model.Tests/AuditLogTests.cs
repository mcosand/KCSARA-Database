  ...
  public class AuditLogTests
  {
    ...
    public void LogPrincipalChanged()
    {
      ...
      using (var db = new KcsarContext(this.databaseLocation))
      {
        ...
        address = new MemberAddressRow { Member = first, Street = "123", City = "Any", State = "WA", Zip = "98765" };
      ...
      using (var db = new KcsarContext(this.databaseLocation))
      {
        ...
        address.Member = db.Members.Single(f => f.Id == second.Id);
        db.SaveChanges();
      }
